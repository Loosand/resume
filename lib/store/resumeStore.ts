...
export const useResumeStore = create<ResumeStore>()(
  persist(
    (set) => ({
      ...
      resetResumeMarkdown: () =>
        set({ resumeMarkdown: initialResumeMarkdown2 }),
